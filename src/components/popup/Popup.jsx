            ...
            <div className="popup__inner">
                ...
                <div className="popup__columns">
                    ...
                    <div className="popup__gallery gallery">
                        ...
                        <img srcSet="img/car-big.jpg" srcSetset="img/car-big-2x.jpg 2x" width="520" height="340" alt="Ford Mustang 2020" />
                        </div>
                        <ul className="gallery__list">
                        <li className="gallery__item gallery__item--active">
                            <img srcSet="img/car1.jpg" srcSetset="img/car1-2x.jpg 2x" alt="Ford Mustang 2020" width="124" height="80" />
                        </li>
                        <li className="gallery__item">
                            <img srcSet="img/car2.jpg" srcSetset="img/car2-2x.jpg 2x" alt="Ford Mustang 2020" width="124" height="80" />
                        </li>
                        <li className="gallery__item">
                            <img srcSet="img/car3.jpg" srcSetset="img/car3-2x.jpg 2x" alt="Ford Mustang 2020" width="124" height="80" />
                        </li>
                        <li className="gallery__item">
                            <img srcSet="img/car4.jpg" srcSetset="img/car4-2x.jpg 2x" alt="Ford Mustang 2020" width="124" height="80" />
                        </li>
                        <li className="gallery__item">
                            <img srcSet="img/car5.jpg" srcSetset="img/car5-2x.jpg 2x" alt="Ford Mustang 2020" width="124" height="80" />
                        </li>
                        </ul>
                    </div>
                    ...
                    <div className="popup__map">
                        <img srcSet="img/map.jpg" width="268" height="180" alt="Москва, Нахимовский проспект, дом 5" />
                    </div>
